...
public class DateChooser extends JPanel {
    ...
    private Font titleFont = new Font("Microsoft YaHei", Font.PLAIN, 14);
    private Font titleH2Font = new Font("Microsoft YaHei", Font.PLAIN, 18);
    ...
    private void commit() {
        if (showDate instanceof JTextField) {
            ((JTextField) showDate).setFont(new Font("Microsoft YaHei", Font.PLAIN, 16));
    ...
    private class TitlePanel extends JPanel {
        ...
        public TitlePanel() {
            ...
            this.setBackground(new Color(83, 109, 254));
            initTitlePanel();
        }
        ...
        private void initTitlePanel() {
            ...
            preYear.setFont(titleH2Font);
            preMonth.setFont(titleH2Font);
